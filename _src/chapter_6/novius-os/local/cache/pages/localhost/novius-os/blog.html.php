...
<div id="content" class="container-fluid">
    ...
    <li class="lvl0"><a class=" active" href="http://localhost/novius-os/blog.html">Blog</a></li><li class="lvl0"><a href="http://localhost/novius-os/monkey.html">Monkey</a></li>    </ul>
            </div>
...
<div  class="row  ">
        ...
        <div id="block-grid" class=" customisable col-md-12 col-sm-12 col-xs-12 main_wysiwyg"><h1 id="pagename">Blog</h1>
...
<div class='div_layout col-md-12' style='' data-val=1><div class="noviusos_blog noviusos_enhancer blognews_posts_list">
        <div class="blognews_list">
<div class="blognews_post blognews_post_item">
    <div class="blognews_primary_information">
                <h2 class="blognews_title"><a href="http://localhost/novius-os/blog/def.html">My first post</a></h2>            <div class="blognews_summary">
        <p>Summary 1</p>
    </div>
        </div>
...
<div class="blognews_post blognews_post_item">
    <div class="blognews_primary_information">
                <h2 class="blognews_title"><a href="http://localhost/novius-os/blog/abc.html">My second post</a></h2>            <div class="blognews_summary">
        <p>Summary 2</p>
    </div>
        </div>
    <div class="blognews_secondary_information">
