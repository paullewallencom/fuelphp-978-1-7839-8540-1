...
return array(
    ...
    'Name (e.g. Monkey):' => 'Nome (ex. Monkey):',

    #: views/admin/form/basic/model_inside.view.php:23
    'Table name (e.g. monkeys):' => 'Nome da tabela (ex. Monkeys):',

    #: views/admin/form/basic/model_inside.view.php:29
    'Column prefix (e.g. monk_):' => 'Prefixo da coluna (ex. monk_)',

    #: views/admin/form/basic/model_inside.view.php:36
    'URL enhancer: This model content is to meant to be published online.' => 'Aprimorador de URL: Este modelo de conteúdo se destina a ser publicado online.',

    #: views/admin/form/basic/model_inside.view.php:42
    'Twinnable behaviour: This model content is available in different versions depending on the language or context.' => 'Comportamento replicável: Este modelo está disponível em versões diferentes dependendo da língua ou contexto.',
    ...
    'Install the application on this Novius OS?' => 'Você deseja instalar a aplicação neste Novius OS?',
    ...
    '‘Build your app’ wizard' => 'Assistente de desenvolvimento de aplicações',
    ...
    'The application wizard needs to be able to write in the local/applications folder. Please change the folder permissions.' => 'O assistente de aplicações precisa de permissão de escrita na pasta local/applications. Por favor, altere as permissões dessa pasta.',

    #: views/admin/form/basic/error/not_writable.view.php:21
    'You could execute the following command line for doing so:' => 'Você pode executar o seguinte comando para fazer isso:',

    #: views/admin/form/basic/error/not_writable.view.php:28
    'Refresh when you are ready.' => 'Atualize quando estiver pronto.',
    ...
    'Bravo! Your application has been created. If you’ve chosen to install it on this Novius OS, go to the home tab to try it out.' => 'Parabéns! Sua aplicação foi criada. Se você escolheu instalá-la neste Novius OS, vá para a guia inicial e teste-a.',
